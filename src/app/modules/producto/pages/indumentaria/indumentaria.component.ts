...
export class IndumentariaComponent {
  productos: Producto[] = [
    ...
    { id: 4, nombre: 'SHORTS', precio: 15000, imagenUrl: 'https://static.zara.net/assets/public/ab91/22bb/4e0d4d2ea84c/36fae9d6ac53/03660801400-e1/03660801400-e1.jpg?ts=1731340041137&w=1366', liked: false },
   ...
   * Si la cantidad llega a 0, elimina el producto por completo.
   * @param producto Producto del que se eliminará una unidad
   */
  eliminarUnoDelCarrito(producto: Producto): void {
    const itemEnCarrito = this.carrito.find(item => item.producto.id === producto.id);
    if (itemEnCarrito) {
      itemEnCarrito.cantidad -= 1;
